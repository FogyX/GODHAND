...
//2022/04/25 (有)アーガイル UnityAssetStoreに出品するにあたり、キャラクターに合うように、スクリプトの一部を変更させて頂きました。
//2022/04/25 Argyle, Inc. We have changed some of the scripts to fit the character to be displayed on the UnityAssetStore.
//
using UnityEngine;
using System.Collections;
using System.Security;

namespace Ag001_SionKun
{
	public class Ag001_AutoBlink : MonoBehaviour
	{
		...
		void SetCloseEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (7, ratio_Close);
		}

		void SetHalfCloseEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (7, ratio_HalfClose);
		}

		void SetOpenEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (7, ratio_Open);
		}
